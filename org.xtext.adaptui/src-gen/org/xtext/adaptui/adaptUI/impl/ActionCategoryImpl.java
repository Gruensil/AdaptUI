 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.adaptui.adaptUI.impl.ActionCategoryImpl#getActionCategory <em>Action Category</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionCategoryImpl extends MinimalEObjectImpl.Container implements ActionCategory
{
  ...
  {
    return AdaptUIPackage.Literals.ACTION_CATEGORY;
  }
  ...
  public NotificationChain basicSetActionCategory(ParentOperation newActionCategory, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AdaptUIPackage.ACTION_CATEGORY__ACTION_CATEGORY, oldActionCategory, newActionCategory);
  ...
  public void setActionCategory(ParentOperation newActionCategory)
  {
    if (newActionCategory != actionCategory)
    {
      ...
      if (actionCategory != null)
        msgs = ((InternalEObject)actionCategory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AdaptUIPackage.ACTION_CATEGORY__ACTION_CATEGORY, null, msgs);
      if (newActionCategory != null)
        msgs = ((InternalEObject)newActionCategory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AdaptUIPackage.ACTION_CATEGORY__ACTION_CATEGORY, null, msgs);
      msgs = basicSetActionCategory(newActionCategory, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AdaptUIPackage.ACTION_CATEGORY__ACTION_CATEGORY, newActionCategory, newActionCategory));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AdaptUIPackage.ACTION_CATEGORY__ACTION_CATEGORY:
