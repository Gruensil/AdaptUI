 ...
 * @generated
 */
public class AdaptUIPackageImpl extends EPackageImpl implements AdaptUIPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.adaptui.adaptUI.AdaptUIPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private AdaptUIPackageImpl()
  {
    super(eNS_URI, AdaptUIFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link AdaptUIPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static AdaptUIPackage init()
  {
    if (isInited) return (AdaptUIPackage)EPackage.Registry.INSTANCE.getEPackage(AdaptUIPackage.eNS_URI);

    // Obtain or create and register package
    AdaptUIPackageImpl theAdaptUIPackage = (AdaptUIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AdaptUIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AdaptUIPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theAdaptUIPackage.createPackageContents();

    // Initialize created meta-data
    theAdaptUIPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theAdaptUIPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(AdaptUIPackage.eNS_URI, theAdaptUIPackage);
    return theAdaptUIPackage;
  }
   ...
   * @generated
   */
  public AdaptUIFactory getAdaptUIFactory()
  {
    return (AdaptUIFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(enumEClass, org.xtext.adaptui.adaptUI.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEnum_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.xtext.adaptui.adaptUI.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(typeEClass, org.xtext.adaptui.adaptUI.TYPE.class, "TYPE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTYPE_String(), ecorePackage.getEString(), "string", null, 0, 1, org.xtext.adaptui.adaptUI.TYPE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTYPE_Number(), ecorePackage.getEString(), "number", null, 0, 1, org.xtext.adaptui.adaptUI.TYPE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTYPE_Boolean(), ecorePackage.getEString(), "boolean", null, 0, 1, org.xtext.adaptui.adaptUI.TYPE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getTYPE_Deftype(), this.getDefType(), null, "deftype", null, 0, 1, org.xtext.adaptui.adaptUI.TYPE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
