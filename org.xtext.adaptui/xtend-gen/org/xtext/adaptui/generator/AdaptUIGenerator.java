...
public class AdaptUIGenerator extends AbstractGenerator {
  @Override
  ...
  public CharSequence compile(final Model model) {
    ...
    _builder.append("<?xml version=\"1.0\" encoding=\"ASCII\"?><adaptUIModel xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><contextModel>");
    {
    ...
    _builder.append("</flow></adaptationModel></adaptUIModel>");
    return _builder;
  }
