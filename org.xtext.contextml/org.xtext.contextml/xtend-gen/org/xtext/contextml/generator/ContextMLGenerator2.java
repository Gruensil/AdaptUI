...
public class ContextMLGenerator2 extends AbstractGenerator {
  @Override
  ...
  public CharSequence compile(final Model model) {
    ...
    _builder.newLine();
    _builder.append("<contextMLModel xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append("</adaptationModel>");
    _builder.newLine();
    _builder.append("</contextMLModel>");
    _builder.newLine();
    return _builder;
  }
