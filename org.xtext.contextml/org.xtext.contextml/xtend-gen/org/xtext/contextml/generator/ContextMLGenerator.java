...
public class ContextMLGenerator extends AbstractGenerator {
  @Override
  ...
  public CharSequence compile(final Model model) {
    ...
    _builder.append("<?xml version=\"1.0\" encoding=\"ASCII\"?><contextMLModel xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><contextModel>");
    {
    ...
    _builder.append("</contextModel><adaptationModel>");
    {
    ...
    _builder.append("</flow></adaptationModel></contextMLModel>");
    return _builder;
  }
  ...
  public CharSequence compile(final Enums enus) {
    StringConcatenation _builder = new StringConcatenation();
    {
      org.xtext.contextml.contextML.Enum _this = enus.getThis();
      boolean _tripleNotEquals = (_this != null);
      if (_tripleNotEquals) {
