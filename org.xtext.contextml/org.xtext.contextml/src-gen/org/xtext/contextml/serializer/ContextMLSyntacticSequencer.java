...
public class ContextMLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ContextMLGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ContextMLGrammarAccess) access;
