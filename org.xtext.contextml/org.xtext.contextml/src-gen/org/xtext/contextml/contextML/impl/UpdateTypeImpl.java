 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.contextml.contextML.impl.UpdateTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.xtext.contextml.contextML.impl.UpdateTypeImpl#getSlow <em>Slow</em>}</li>
 *   <li>{@link org.xtext.contextml.contextML.impl.UpdateTypeImpl#getFast <em>Fast</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateTypeImpl extends MinimalEObjectImpl.Container implements UpdateType
{
  ...
  {
    return ContextMLPackage.Literals.UPDATE_TYPE;
  }
  ...
  public void setEvent(String newEvent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.UPDATE_TYPE__EVENT, oldEvent, event));
  }
  ...
  public void setSlow(String newSlow)
  {
    ...
    slow = newSlow;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.UPDATE_TYPE__SLOW, oldSlow, slow));
  }
  ...
  public void setFast(String newFast)
  {
    ...
    fast = newFast;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.UPDATE_TYPE__FAST, oldFast, fast));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ContextMLPackage.UPDATE_TYPE__EVENT:
        return getEvent();
      case ContextMLPackage.UPDATE_TYPE__SLOW:
        return getSlow();
      case ContextMLPackage.UPDATE_TYPE__FAST:
        return getFast();
    }
