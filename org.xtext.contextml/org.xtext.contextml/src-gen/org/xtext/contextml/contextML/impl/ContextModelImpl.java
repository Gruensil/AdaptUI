 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.contextml.contextML.impl.ContextModelImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link org.xtext.contextml.contextML.impl.ContextModelImpl#getProvider <em>Provider</em>}</li>
 *   <li>{@link org.xtext.contextml.contextML.impl.ContextModelImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextModelImpl extends MinimalEObjectImpl.Container implements ContextModel
{
  ...
  {
    return ContextMLPackage.Literals.CONTEXT_MODEL;
  }
  ...
  public EList<Entity> getEntity()
  {
    if (entity == null)
    {
      entity = new EObjectContainmentEList<Entity>(Entity.class, this, ContextMLPackage.CONTEXT_MODEL__ENTITY);
    }
    return entity;
  }
  ...
  public EList<Provider> getProvider()
  {
    if (provider == null)
    {
      provider = new EObjectContainmentEList<Provider>(Provider.class, this, ContextMLPackage.CONTEXT_MODEL__PROVIDER);
    }
    return provider;
  }
  ...
  public NotificationChain basicSetTypes(DefTypes newTypes, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ContextMLPackage.CONTEXT_MODEL__TYPES, oldTypes, newTypes);
  ...
  public void setTypes(DefTypes newTypes)
  {
    if (newTypes != types)
    {
      ...
      if (types != null)
        msgs = ((InternalEObject)types).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ContextMLPackage.CONTEXT_MODEL__TYPES, null, msgs);
      if (newTypes != null)
        msgs = ((InternalEObject)newTypes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ContextMLPackage.CONTEXT_MODEL__TYPES, null, msgs);
      msgs = basicSetTypes(newTypes, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.CONTEXT_MODEL__TYPES, newTypes, newTypes));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ContextMLPackage.CONTEXT_MODEL__ENTITY:
        return ((InternalEList<?>)getEntity()).basicRemove(otherEnd, msgs);
      case ContextMLPackage.CONTEXT_MODEL__PROVIDER:
        return ((InternalEList<?>)getProvider()).basicRemove(otherEnd, msgs);
      case ContextMLPackage.CONTEXT_MODEL__TYPES:
