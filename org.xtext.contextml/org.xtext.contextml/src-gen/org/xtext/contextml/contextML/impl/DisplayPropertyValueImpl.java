 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.contextml.contextML.impl.DisplayPropertyValueImpl#getPropertyClass <em>Property Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisplayPropertyValueImpl extends MinimalEObjectImpl.Container implements DisplayPropertyValue
{
  ...
  {
    return ContextMLPackage.Literals.DISPLAY_PROPERTY_VALUE;
  }
  ...
  public NotificationChain basicSetPropertyClass(EObject newPropertyClass, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ContextMLPackage.DISPLAY_PROPERTY_VALUE__PROPERTY_CLASS, oldPropertyClass, newPropertyClass);
  ...
  public void setPropertyClass(EObject newPropertyClass)
  {
    if (newPropertyClass != propertyClass)
    {
      ...
      if (propertyClass != null)
        msgs = ((InternalEObject)propertyClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ContextMLPackage.DISPLAY_PROPERTY_VALUE__PROPERTY_CLASS, null, msgs);
      if (newPropertyClass != null)
        msgs = ((InternalEObject)newPropertyClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ContextMLPackage.DISPLAY_PROPERTY_VALUE__PROPERTY_CLASS, null, msgs);
      msgs = basicSetPropertyClass(newPropertyClass, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.DISPLAY_PROPERTY_VALUE__PROPERTY_CLASS, newPropertyClass, newPropertyClass));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ContextMLPackage.DISPLAY_PROPERTY_VALUE__PROPERTY_CLASS:
